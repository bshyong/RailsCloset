...
class OutfitsControllerTest < ActionController::TestCase
  ...
  test "should create outfit" do
    assert_difference('Outfit.count') do
      post :create, outfit: { description: @outfit.description, last_worn: @outfit.last_worn, name: @outfit.name, rating: @outfit.rating }
    end
  ...
  test "should update outfit" do
    patch :update, id: @outfit, outfit: { description: @outfit.description, last_worn: @outfit.last_worn, name: @outfit.name, rating: @outfit.rating }
    assert_redirected_to outfit_path(assigns(:outfit))
  end
