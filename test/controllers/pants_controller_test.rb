...
class PantsControllerTest < ActionController::TestCase
  ...
  test "should create pant" do
    assert_difference('Pant.count') do
      post :create, pant: { date_acquired: @pant.date_acquired, last_worn: @pant.last_worn, name: @pant.name, price: @pant.price }
    end
  ...
  test "should update pant" do
    patch :update, id: @pant, pant: { date_acquired: @pant.date_acquired, last_worn: @pant.last_worn, name: @pant.name, price: @pant.price }
    assert_redirected_to pant_path(assigns(:pant))
  end
